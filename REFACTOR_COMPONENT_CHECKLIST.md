...
- [ ] `packages/core/src/__tests__/event-handlers.test.ts orchestrator event handlers runtime collaborator guardrail follow-up`
...
- [ ] `packages/core/src/__tests__/helpers/event-handlers-test.utils.ts event handler runtime fixture boundary follow-up`
