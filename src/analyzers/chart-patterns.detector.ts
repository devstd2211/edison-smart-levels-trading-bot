import { CONFIDENCE_BOUNDS, CONFIDENCE_THRESHOLDS, DECIMAL_PLACES, INTEGER_MULTIPLIERS, PERCENT_MULTIPLIER, PERCENTAGE_THRESHOLDS, RATIO_MULTIPLIERS, TIME_UNITS } from '../constants';
