import { DECIMAL_PLACES, MULTIPLIERS, PERCENTAGE_THRESHOLDS, PERCENT_MULTIPLIER, CONFIDENCE_BOUNDS, RATIO_MULTIPLIERS, INTEGER_MULTIPLIERS, THRESHOLD_VALUES, MULTIPLIER_VALUES } from '../constants';
/**
 * Entry Scanner
 *
