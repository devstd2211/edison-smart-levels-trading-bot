...
type AnalyzerEngineServiceSuiteState = Pick<
...
describe('AnalyzerEngineService', () => {
  ...
  let createScenario: AnalyzerEngineServiceSuiteState['createScenario'];
  let cleanup: AnalyzerEngineServiceSuiteState['cleanup'];
