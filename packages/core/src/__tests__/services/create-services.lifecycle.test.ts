...
type ManagedTrackedServicesContext = ReturnType<
  typeof createManagedTrackedServicesContext
>;
...
describe('createServices lifecycle orchestration', () => {
  ...
  beforeEach(() => {
    ({
      ...
      cleanup,
    } = createManagedTrackedServicesContext() as TrackedServicesFactories);
  });
