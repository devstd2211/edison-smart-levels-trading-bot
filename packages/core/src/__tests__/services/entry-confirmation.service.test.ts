...
describe('EntryConfirmationManager', () => {
  ...
  describe('LONG confirmation logic', () => {
    it('should CONFIRM when candle closes ABOVE support', () => {
      const id = manager.addPending(
        createLongPendingEntryInput({ signalData: { type: 'LEVEL_BASED' } }),
      );
  ...
  describe('expiry handling', () => {
    ...
    it('should cleanup expired entries', () => {
      ...
      manager.addPending(createLongPendingEntryInput({ detectedAt: startTime }));
      manager.addPending(createShortPendingEntryInput({ detectedAt: startTime }));
      manager.addPending(
        createLongPendingEntryInput({
          symbol: 'ETHUSDT',
          keyLevel: 3000,
  ...
  describe('cancel and clear', () => {
    ...
    it('should clear all pending entries', () => {
      ...
      manager.addPending(createShortPendingEntryInput());
  ...
  describe('multiple pending entries', () => {
    it('should handle multiple pending entries independently', () => {
      const id1 = manager.addPending(createLongPendingEntryInput());
  ...
  describe('signal data preservation', () => {
    it('should preserve original signal data', () => {
      ...
      const id = manager.addPending({
        ...createLongPendingEntryInput({ signalData }),
      });
