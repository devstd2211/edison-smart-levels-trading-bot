...
describe('TickDeltaAnalyzerService', () => {
  let service: TickDeltaAnalyzerSuiteState['service'];
  let createService: TickDeltaAnalyzerSuiteState['createService'];
  let cleanup: TickDeltaAnalyzerSuiteState['cleanup'];
