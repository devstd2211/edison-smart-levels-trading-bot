...
- [x] Recovery-track status snapshot (2026-03-06): 7/10 candidates done (`position-exiting.service.ts`, `position-lifecycle.service.ts`, `trading-journal.service.ts`, `websocket-manager.service.ts`, `public-websocket.service.ts`, `telegram.service.ts`, `handlers/websocket.handler.ts`), 3/10 pending (`divergence.analyzer-new`, `bollinger-bands.analyzer-new`, `logger.service`)
