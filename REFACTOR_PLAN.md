...
- [x] Recovery-track status snapshot (2026-03-06): 3/10 candidates done (`position-exiting.service.ts`, `position-lifecycle.service.ts`, `trading-journal.service.ts`), 7/10 pending (`websocket-manager`, `public-websocket`, `telegram`, `handlers/websocket.handler`, `divergence.analyzer-new`, `bollinger-bands.analyzer-new`, `logger.service`)
