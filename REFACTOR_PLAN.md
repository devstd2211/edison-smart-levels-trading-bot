...
- [x] Recovery-track status snapshot (2026-03-06): 9/10 candidates done (`position-exiting.service.ts`, `position-lifecycle.service.ts`, `trading-journal.service.ts`, `websocket-manager.service.ts`, `public-websocket.service.ts`, `telegram.service.ts`, `handlers/websocket.handler.ts`, `divergence.analyzer-new.ts`, `bollinger-bands.analyzer-new.ts`), 1/10 pending (`logger.service`)
