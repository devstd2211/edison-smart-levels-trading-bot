...
- [x] Related services reviewed (batch 84-88): `StrategyProcessingPoolService`, `PositionExitingService` (no safe behavior-preserving decomposition required in this pass)
