...
- [x] Recovery-track status snapshot (2026-03-06): 5/10 candidates done (`position-exiting.service.ts`, `position-lifecycle.service.ts`, `trading-journal.service.ts`, `websocket-manager.service.ts`, `public-websocket.service.ts`), 5/10 pending (`telegram`, `handlers/websocket.handler`, `divergence.analyzer-new`, `bollinger-bands.analyzer-new`, `logger.service`)
