...
- [ ] God-object candidate: `packages/core/src/services/trading-journal.service.ts` (score 6; ~759 LOC, 7 ctor params, 43 methods) — separate write-model, read/query-model, and stats aggregation adapters
- [ ] God-object candidate: `packages/core/src/services/websocket-manager.service.ts` (score 5; ~792 LOC, 7 ctor params, 43 methods) — isolate connection lifecycle, auth/retry, and subscription routing
- [ ] God-object candidate: `packages/core/src/services/public-websocket.service.ts` (score 5; ~571 LOC, 6 ctor params, 55 methods) — isolate message parsing, reconnect policy, and channel dispatch
- [ ] God-object candidate: `packages/core/src/services/telegram.service.ts` (score 5; ~615 LOC, 3 ctor params, 46 methods) — isolate message formatting from transport/retry
- [ ] God-object candidate: `packages/core/src/services/handlers/websocket.handler.ts` (score 5; ~611 LOC, 7 ctor params, 45 methods) — split event decoding vs action routing
- [ ] God-object candidate: `packages/core/src/analyzers/divergence.analyzer-new.ts` (score 5; ~629 LOC, 2 ctor params, 49 methods) — split detection primitives vs signal assembly
- [ ] God-object candidate: `packages/core/src/analyzers/bollinger-bands.analyzer-new.ts` (score 5; ~521 LOC, 3 ctor params, 39 methods) — split band computation/validation from decision rules
- [ ] Cross-cutting god-object hotspot: `packages/core/src/services/logger.service.ts` (score 5; ~479 LOC, test reach 54 files) — introduce logger facade + sink adapters to reduce constructor/test coupling
- [x] Recovery-track status snapshot (2026-03-06): 2/10 candidates done (`position-exiting.service.ts`, `position-lifecycle.service.ts`), 8/10 pending (`trading-journal`, `websocket-manager`, `public-websocket`, `telegram`, `handlers/websocket.handler`, `divergence.analyzer-new`, `bollinger-bands.analyzer-new`, `logger.service`)
