...
- [x] Recovery-track status snapshot (2026-03-06): 4/10 candidates done (`position-exiting.service.ts`, `position-lifecycle.service.ts`, `trading-journal.service.ts`, `websocket-manager.service.ts`), 6/10 pending (`public-websocket`, `telegram`, `handlers/websocket.handler`, `divergence.analyzer-new`, `bollinger-bands.analyzer-new`, `logger.service`)
