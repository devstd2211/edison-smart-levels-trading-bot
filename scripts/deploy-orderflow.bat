@echo off
REM Deploy Scalping Order Flow Strategy to dedicated folder
REM Symbol: XLMUSDT
REM Strategy: ScalpingOrderFlow (Phase 5)

echo ========================================
echo Deploying Order Flow Strategy (XLMUSDT)
echo ========================================

set SOURCE_DIR=D:\src\Edison
set DEPLOY_DIR=D:\src\Edison - orderflow
...
REM Copy custom config for Order Flow
copy /Y "%SOURCE_DIR%\configs\config-orderflow.json" "%DEPLOY_DIR%\config.json"
...
echo ========================================
echo.
echo Strategy: Scalping Order Flow
echo Symbol: XLMUSDT
