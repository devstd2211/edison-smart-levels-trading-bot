@echo off
REM Deploy Scalping Ladder TP Strategy to dedicated folder
REM Symbol: HYPEUSDT
REM Strategy: ScalpingLadderTp (Phase 3)

echo ========================================
echo Deploying Ladder TP Strategy (HYPEUSDT)
echo ========================================

set SOURCE_DIR=D:\src\Edison
set DEPLOY_DIR=D:\src\Edison - laddertp
...
REM Copy custom config for Ladder TP
copy /Y "%SOURCE_DIR%\configs\config-laddertp.json" "%DEPLOY_DIR%\config.json"
...
echo ========================================
echo.
echo Strategy: Scalping Ladder TP
echo Symbol: HYPEUSDT
