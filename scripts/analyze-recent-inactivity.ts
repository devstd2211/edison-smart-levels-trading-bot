...
async function main() {
  console.log('═══════════════════════════════════════════════════════════════');
  console.log(`${ICONS.search} ANALYZING RECENT BOT INACTIVITY`);
  console.log('═══════════════════════════════════════════════════════════════\n');
...
`);
  ...
  console.log(`
${ICONS.chart} Analyzing last 200 5m candles...`);
  ...
  console.log(`${ICONS.wrench} Testing ZigZag depths to find swing points:
`);
  ...
  console.log(`
${ICONS.chart_up} Market Indicators (last candle):`);
  ...
  console.log(`
${ICONS.ruler} Price Range Analysis (200 candles):` );
  ...
  console.log(`
${ICONS.chart} Recent Volatility (last 20 candles):`);
  ...
  // Strategy checks
  console.log(`
${ICONS.target} Strategy Analysis:`);

  console.log(`
   ${ICONS.keycap_1} TrendFollowing:`);
  ...
  console.log(`
   ${ICONS.keycap_2} LevelBased (depth=12):`);
