@echo off
REM Deploy Scalping Limit Order Strategy to dedicated folder
REM Symbol: ADAUSDT
REM Strategy: ScalpingLimitOrder (Phase 4)

echo ========================================
echo Deploying Limit Order Strategy (ADAUSDT)
echo ========================================

set SOURCE_DIR=D:\src\Edison
set DEPLOY_DIR=D:\src\Edison - limitorder
...
REM Copy custom config for Limit Order
copy /Y "%SOURCE_DIR%\configs\config-limitorder.json" "%DEPLOY_DIR%\config.json"
...
echo ========================================
echo.
echo Strategy: Scalping Limit Order
echo Symbol: ADAUSDT
