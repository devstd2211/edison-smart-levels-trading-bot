...
- CLI default API/WS ports are static runtime constants in `packages/core/src/cli/cli-runtime.ts`; `API_PORT` and `WS_PORT` override only those embedded defaults.
